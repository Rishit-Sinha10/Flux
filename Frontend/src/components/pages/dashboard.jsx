...
function StatCard({
  ...
  return (
    ...
    >
      ...
      >
        <span
          style={{ fontSize: "0.78rem", fontWeight: 500, color: "#5C6070" }}
        >
          {label}
        </span>
        <div
    ...
    <div>
      {items.map((item, i) => (
        <div key={i}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                {item.titleParts.map((part, j) =>
                  part.highlight ? (
                    <span key={j} style={{ color: "#3B82F6", fontWeight: 600 }}>
                      {part.text}
                    </span>
                  ) : (
              ...
              <div
                style={{ fontSize: "0.72rem", color: "#9BA3AF", marginTop: 2 }}
              >
                {item.meta}
              </div>
            </div>
          ...
          {i < items.length - 1 && (
            <div
              style={{ height: 1, background: "#F2F4F7", margin: "0 22px" }}
            />
          )}
        </div>
      ))}
...
function AnalyticsChart({
  ...
  const purpleArea =
    purplePath + ` L${toX(data.length - 1)},160 L${toX(0)},160 Z`;
  return (
    <div>
      {/* Header */}
      <div
      ...
      >
        <div>
          ...
          <div style={{ fontSize: "0.75rem", color: "#9BA3AF", marginTop: 2 }}>
            Daily active viewers over time
          </div>
        </div>
      ...
      {/* Legend */}
      <div
        style={{ display: "flex", gap: 16, padding: "0 22px", marginBottom: 8 }}
      >
        {[
          { color: "#3B82F6", label: "Viewers" },
          { color: "#8B5CF6", label: "Subscribers" },
        ].map((l) => (
          <div
            key={l.label}
            style={{
      ...
      <div style={{ padding: "0 22px 20px" }}>
        ...
        >
          ...
          {[
            { y: 163, label: "0" },
            { y: 123, label: Math.round(maxVal * 0.33).toLocaleString() },
            { y: 83, label: Math.round(maxVal * 0.66).toLocaleString() },
            { y: 43, label: maxVal.toLocaleString() },
          ].map((l) => (
            <text
              key={l.y}
              x="4"
...
function TrafficSourceRow({
  ...
  return (
    ...
    >
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: "0.8rem", fontWeight: 500, color: "#0D0F14" }}>
          {source}
        </div>
      ...
      <div
        style={{
          ...
          fontSize: "0.75rem",
          fontWeight: 500,
          color: changeDelta >= 0 ? "#10B981" : "#EF4444",
        }}
      >
        {changeDelta >= 0 ? "+" : ""}
        {change}
        ...
        >
          ...
          <Card>
            <AnalyticsChart
              data={chartData}
              labels={chartLabels}
              rangeOptions={chartRangeOptions}
            />
          </Card>
        ...
        >
          ...
          <Card>
            ...
            <div style={{ paddingTop: 4, paddingBottom: 8 }}>
              {/* Table header */}
              <div
                style={{ display: "flex", gap: 12, padding: "10px 22px 6px" }}
              >
