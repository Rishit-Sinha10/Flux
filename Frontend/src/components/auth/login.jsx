...
export default function Login() {
  ...
  useEffect(() => {
    if (isLoaded && isSignedIn) {
      console.log("[Login] User is signed in, redirecting to dashboard in 2 seconds...");
  ...
  if (isLoaded && isSignedIn) {
    return (
      <AuthLayout
        ...
        subtitle="You are authenticated and can access the dashboard"
      >
        <motion.div
  ...
  return (
    <AuthLayout title="Welcome Back" subtitle="Sign in to your account">
      <div className="space-y-6">
        ...
        {/* Legacy Email/Password (Optional) */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
